...
// GetQueryList provides a mock function with given fields: pathSearch
func (_m *MockZoxide) GetQueryList(pathSearch string) ([]string, error) {
	ret := _m.Called(pathSearch)

	if len(ret) == 0 {
		panic("no return value specified for GetQueryList")
	}

	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]string, error)); ok {
		return rf(pathSearch)
	}
...
// MockZoxide_GetQueryList_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetQueryList'
type MockZoxide_GetQueryList_Call struct {
	*mock.Call
}

// GetQueryList is a helper method to define mock.On call
//   - pathSearch string
func (_e *MockZoxide_Expecter) GetQueryList(pathSearch interface{}) *MockZoxide_GetQueryList_Call {
	return &MockZoxide_GetQueryList_Call{Call: _e.mock.On("GetQueryList", pathSearch)}
}

func (_c *MockZoxide_GetQueryList_Call) Run(run func(pathSearch string)) *MockZoxide_GetQueryList_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockZoxide_GetQueryList_Call) Return(_a0 []string, _a1 error) *MockZoxide_GetQueryList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockZoxide_GetQueryList_Call) RunAndReturn(run func(string) ([]string, error)) *MockZoxide_GetQueryList_Call {
	_c.Call.Return(run)
	return _c
}
