...
func TestGetAddWorktreeArguements(t *testing.T) {
	t.Run("Case 1a: New branch exists locally", func(t *testing.T) {
		...
		result := GetAddWorktreeArguements(config)
...
// TestGetAddWorktreeArguementsIntegration tests the function with more realistic scenarios
func TestGetAddWorktreeArguementsIntegration(t *testing.T) {
